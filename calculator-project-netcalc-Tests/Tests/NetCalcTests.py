...
def run_binary():
    ...
    os.system("./build/5_NetCalc/netcalc &") # start server in background
    ...
    try:
        ...
        os.system("pkill netcalc")
        exit(-100)   
    if not os.path.exists("5_NetCalc/client/net_client.py"):
    ...
    print(os.getcwd())
    os.system("python3 5_NetCalc/client/net_client.py -i ./netcalc_tests/unsolved -o ./netcalc_tests/solved")
    print("Called client\n")
    os.system("pkill netcalc")
